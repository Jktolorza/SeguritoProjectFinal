...
public class UsuarioController {
	...
	public ModelAndView editarUsuario(@PathVariable int id, @PathVariable String nickname, @PathVariable String message) {
	...
	public ModelAndView guardarEditUsuario(Usuario u, @RequestParam String oldPassword, RedirectAttributes redirectAttrs) {
